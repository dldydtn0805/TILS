...
> 주어지는 로마숫자 2개를 더한 아라비안 숫자를 만들고, 그 아라비안 숫자를 로마숫자로 더해야했다.
>
> 주어진 조건을 보니 작은 숫자가 큰숫자보다 앞으로 오는 경우인 숫자들은 갯수가 단 1개만 사용할 수 있었다. 그렇다는 건 제일 큰 숫자부터 아라비안 숫자를 바꾸어 가면 된다고 생각했다.
>
> 1. 주어진 예시의 2493을 만들때 먼저 1000을 뜻하는 M으로 최대한 만든다
>
> 2. 나머지 493은 500보다 작고 100보다 크다, 하지만 400보다 큰지 확인을한다. 현재 400보다 크니까 400을 뜻하는 CD를 사용한다.
> 3. 93은 50보다 크고 100보다 작다. 이때, 90보다 큰지 확인한다. 90보다 크기때문에 XC를 사용한다.
> 4. 3은 5보다 작고 1보다 크다. 하지만 4보단 작다. 따라서 I * 3으로 만든다.
>
> 이런 식으로 큰값부터 따지면서 값을 만들었다
>
> 단순 구현으로 문제 해결!